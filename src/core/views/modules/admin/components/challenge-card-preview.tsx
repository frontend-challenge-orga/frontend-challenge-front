...
type Props = {
  currentValues: ChallengeDTO;
  completedChallenges: ChallengeSolutionDTO[];
  session: Session | null;
};

export const ChallengeCardPreview = ({ currentValues, completedChallenges, session }: Props) => {
  const { id, slug, name, description, difficulty, premium } = currentValues;
